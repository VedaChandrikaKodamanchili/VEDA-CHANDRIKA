...
-----------EXERCISE 2.2---//modify table with new columns-------add batch_id and trainer_id------modify datatypes--------------------



alter table Associate_status add Batch_Id varchar(20) Foreign key (Batch_Id) References Batch_Info(Batch_Id)
alter table Associate_status add Trainer_Id varchar(20) Foreign key (Trainer_Id) References Trainer_Info(Trainer_Id)
...
---------------------------------Exercise 2.5//remove record from table-------------------------------------------------------------------------------------------------------------
...
-----------------------------------------Exercise-2.6//fetch first 5 trainers with max experience---------------------------------------------------------------------------------
...
-------------------------------------------Exercise 2.9//remove table from databse---------------------------------------------------------------------------------------------
