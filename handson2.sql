...
create table Student_Info_895203(Reg_Number Varchar(20),
...
select * from Student_Info_895203

---------------------------------------------------------------

Create table Subject_Master_895203(Subject_Code varchar(10),
Subject_Name Varchar(30),
Weightage int)

select * from Subject_Master_895203

-----------------------------------------------------------------

create table Student_Marks_895203(Reg_Number Varchar(20),
Subject_Code varchar(10),
Semester int,
Marks int)

select * from Student_Marks_895203

------------------------------------------------------------------

create table Student_Result_895203(Reg_Number Varchar(20),
Semester int,
GPA int,
Is_Eligible_Scholarship varchar(3))

select * from Student_Result_895203

----------------------------------------------------------------

insert into Student_Info_895203 values('MC101301','James','MCA',9714589787,'12-jan-1984','08-jul-2010','No 10,South Block,Nivea','james.mca@yahoo.com'),
...
insert into Subject_Master_895203 values('EE01DCF','DCF',30),
...
-----------------------------------------------------------------------------------
insert into Student_Marks_895203 values('MC101301','EE01DCF',1,75),
...
insert into Student_Result_895203 values('MC101301',1,7.5,'Y'),
('BEC111402',1,7.1,'Y'),
('BEEI101204',1,8.3,'Y'),
('BEEI101204',2,6.9,'N'),
('MB111305',1,6.5,'N'),
